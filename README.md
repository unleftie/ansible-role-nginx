...
This role installs NGINX (NGINX Open Source), NGINX Plus and NGINX Agent on your target host(s).
...
The NGINX Ansible role aims to work on all platforms supported by the latest mainline/stable release of [NGINX Open Source](https://nginx.org/en/linux_packages.html), [NGINX Plus](https://docs.nginx.com/nginx/technical-specs/), and [NGINX Agent](https://docs.nginx.com/nginx-agent/technical-specifications/).
